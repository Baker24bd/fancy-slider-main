...
const showImages = (images) => {
  if (images.length === 0 || searchInput.value === '') {
    ...
    if (searchInput.value === '') {
      errorMessage.innerHTML = `<h1 class="text-center text-danger mt-4">Sorry please try again.</h1>`;
    } else {
      errorMessage.innerHTML = `<h1 class="text-center text-danger mt-4">This item does not exist, Sorry please try again.</h1>`;
    }
  } else {
